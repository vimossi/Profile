    ...
    <article class="sobre">
      <h1 class="nome">Sobre mim</h1>
        <p>
          ...
          Percebi somente em 2015 a real importância de uma formação mais sólida, quando consegui meu primeiro emprego, em um ambiente com centenas de pessoas em um Call Center, com uma diversidade incrível, onde pude conhecer e desenvolver minhas soft skills de maneira mais árdua e eficiente.<br />
